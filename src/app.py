...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL','sqlite:///data.db')  # -> sqlite3 was just for tests but if he don't find postgresql link he wil use sqlite
